...
public class PermissionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //if the premission is already accepted, move to mainActivity
        ...
        {
            Log.d("myGPS","permission activity called 1");
            Intent intent4 = new Intent(PermissionActivity.this, MainActivity.class);
            intent4.putExtra("allow","True");
